...
import { Zap, Shield, Activity, Lock, TrendingUp, ArrowLeft, Mail } from "lucide-react";
          ...
          {!isSubmitted ? (
            <>
              ...
              <div className="mt-6">
                <Link
                  href="/login"
                  className="w-full flex items-center justify-center gap-2 text-slate-600 hover:text-slate-900 transition-colors font-medium"
                  style={{ fontFamily: "var(--font-sans)" }}
                >
