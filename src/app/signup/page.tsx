        ...
        <div className="bg-white rounded-3xl p-10">
          <div className="mb-8">
            ...
            <p className="text-slate-600" style={{ fontFamily: "var(--font-sans)", fontWeight: 400 }}>
              Join DTR Platform to start trading delivery rights
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-slate-900 mb-2 uppercase tracking-wide" style={{ fontFamily: "var(--font-sans)" }}>
                full name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="company" className="block text-sm font-medium text-slate-900 mb-2 uppercase tracking-wide" style={{ fontFamily: "var(--font-sans)" }}>
                company
              </label>
              <input
                type="text"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-full font-medium hover:from-blue-600 hover:to-blue-700 transition-all transform hover:scale-[1.02] mt-6"
              style={{ fontFamily: "var(--font-sans)" }}
            >
              Create Account
            </button>
