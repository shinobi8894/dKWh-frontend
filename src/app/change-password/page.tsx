      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex items-center justify-center relative overflow-hidden py-12 px-6">
        <div className="absolute left-0 top-1/2 -translate-y-1/2 hidden lg:block">
          <div className="flex flex-col gap-6 pl-12">
            <div className="w-20 h-20 bg-white rounded-3xl flex items-center justify-center transform -rotate-12">
              <Shield className="w-10 h-10 text-slate-400" />
            </div>
            <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl flex items-center justify-center transform rotate-6">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 hidden lg:block">
          <div className="flex flex-col gap-6 pr-12">
            <div className="w-16 h-16 bg-white rounded-3xl flex items-center justify-center transform rotate-12">
              <Lock className="w-8 h-8 text-slate-400" />
            </div>
            <div className="w-24 h-24 bg-slate-900 rounded-3xl flex items-center justify-center transform -rotate-6">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-3xl p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="currentPassword" className="block text-sm font-medium text-slate-900 mb-2 uppercase tracking-wide" style={{ fontFamily: "var(--font-sans)" }}>
                current password
              </label>
              <input
                type="password"
            ...
            <div>
              <label htmlFor="newPassword" className="block text-sm font-medium text-slate-900 mb-2 uppercase tracking-wide" style={{ fontFamily: "var(--font-sans)" }}>
                new password
              </label>
              <input
                type="password"
          ...
          <div className="mt-6 text-center">
            <Link href="/dashboard" className="text-sm text-slate-600 hover:text-slate-900 font-medium" style={{ fontFamily: "var(--font-sans)" }}>
              Back to Dashboard
            </Link>
          </div>
        </div>
